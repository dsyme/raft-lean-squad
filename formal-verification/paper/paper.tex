...
\paragraph{Why standalone components are standalone.}
The 25 standalone files are not isolated by accident.
\texttt{fullProtocolStep\_safe} proves that no two nodes apply
...
(3)~\texttt{TallyVotes} + \texttt{JointTally} + \texttt{JointVote}
...
tally logic.
None of these extensions would change the \emph{statement} of EL7, but
