...
merging pull requests, and writing two short comments across 56
...
The total LLM token cost was approximately \$399 (57~runs at
...
Across 57 runs spanning $\approx$10 weeks, the agent produced:
\begin{itemize}\setlength\itemsep{0pt}
...
55 LLM agent runs (each $\sim$15--30 minutes of wall-clock time)
...
and produced 524 machine-checked theorems across 44 files in 57 runs,
