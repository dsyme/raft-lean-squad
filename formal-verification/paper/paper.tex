...
The total LLM token cost was approximately \$595 (87~runs at
...
proof engineering.  His total intervention over the project's 87~runs
...
\item The entire effort is \emph{automated}: every target selection,
  ...
  LLM-driven FV agent across 87 independent runs, with only two brief
...
Total: 575 theorems, 55~files (37 proof files + 18 correspondence-test files),
...
\midrule
\textbf{Total}    & \textbf{575} & \textbf{0 sorry; 373 \texttt{\#guard}} \\
\bottomrule
\end{tabular}
...
Across 87 runs spanning $\approx$12 weeks, the agent produced:
\begin{itemize}\setlength\itemsep{0pt}
  \item 26 informal specification documents
  \item 55 Lean~4 source files ($\approx$15{,}000 lines)
  \item 575 machine-checked theorems
...
Each of the 69 Lean Squad runs consumed approximately \$7 of LLM
token cost at Claude Sonnet~4.6 pricing (at time of publication), for a total of
approximately~\$399.  This covers the full pipeline: reading
...
Squad accumulates knowledge across 87 independent GitHub Actions runs
...
Our $\approx$15{,}000 lines of Lean and 575 theorems are modest by comparison.
...
87 LLM agent runs (each $\sim$15--30 minutes of wall-clock time)
...
and produced 575 machine-checked theorems across 55 files in 87 runs,
